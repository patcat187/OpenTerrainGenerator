...
public class WorldConfig extends ConfigFile
{
    ...
    protected void readConfigSettings(SettingsMap reader)
    {
        ...
        if(dimensionBelowHeight >= dimensionAboveHeight)
        {
        	dimensionBelowHeight = WorldStandardValues.DIMENSIONBELOWHEIGHT.getDefaultValue();
        	dimensionAboveHeight = WorldStandardValues.DIMENSIONABOVEHEIGHT.getDefaultValue();

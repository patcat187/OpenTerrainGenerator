...
public class WorldProviderTX extends WorldProvider
{
	...
	private WorldConfig GetWorldConfig()
	{
		if(config == null)
		{
			ForgeWorld forgeWorld = (ForgeWorld)((ForgeEngine)TerrainControl.getEngine()).getWorld(worldObj);
			if(forgeWorld != null)
			{
    ...
    {
    	this.biomeProvider = TXPlugin.txWorldType.getBiomeProvider(worldObj);
    }
    
    @Override
    public IChunkGenerator createChunkGenerator()
    {
    	return TXPlugin.txWorldType.getChunkGenerator(worldObj, worldObj.getWorldInfo().getGeneratorOptions());
    }

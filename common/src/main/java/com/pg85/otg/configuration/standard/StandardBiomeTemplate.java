...
public class StandardBiomeTemplate
{
    ...
    public List<Resource> createDefaultResources(BiomeConfig config)
    {
        ...
        {
            resources.add(Resource.createResource(config, UnderWaterOreGen.class, LocalMaterials.GRAVEL, WaterGravelDepositSize,
                    defaultWaterGravel,
                    WaterGravelDepositRarity, LocalMaterials.DIRT, LocalMaterials.GRASS));
        }

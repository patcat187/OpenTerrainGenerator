...
public abstract class TerrainGenBase
{
    ...
    protected final LocalMaterialData air = MaterialHelper.toLocalMaterialData(DefaultMaterial.AIR);
    protected final LocalMaterialData lava = MaterialHelper.toLocalMaterialData(DefaultMaterial.LAVA);
